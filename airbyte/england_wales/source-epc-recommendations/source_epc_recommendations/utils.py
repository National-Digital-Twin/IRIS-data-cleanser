"""Coefficient C477 Data Cleanser - Recommendations for England and Wales.
...
def requests_cached(url, params, logger, auth_key=None):
    """Wrapper for caching requests."""
    if not auth_key:
        auth_key = "Basic INSERT_YOUR_EPC_API_KEY_HERE"
...
def fetch_recommendations_for_segment(
    ...
    while True:
        ...
        df = requests_cached(url=url, params=params, logger=logger, auth_key=auth_key)
