...
class SourceEpcRecommendations(Source):
    def check(self, logger: AirbyteLogger, config: json) -> AirbyteConnectionStatus:
        ...
        try:
            ...
            counter = 0
            for property_type in ["domestic", "non-domestic"]:
                url = f"{base_url}/{property_type}/search"
                response = s.get(
            ...
            # Ensure both domestic and non-domestic requests were successful
            if counter == 2:
    ...
    def discover(self, logger: AirbyteLogger, config: json) -> AirbyteCatalog:
        ...
        stream_name = "england_wales_recommendations"
        json_schema = {
            ...
            "properties": {
                "LMK_KEY": {"type": "string"},
                "IMPROVEMENT_ITEM": {"type": ["null", "number"]},
                ...
                "RECOMMENDATION_ITEM": {"type": ["null", "number"]},
                "RECOMMENDATION_CODE": {"type": ["null", "string"]},
                "RECOMMENDATION": {"type": ["null", "string"]},
                "CO2_IMPACT": {"type": ["null", "string"]},
                "PROPERTY_TYPE": {"type": ["null", "string"]},
                "LOCAL_AUTHORITY": {"type": ["null", "string"]},
                "YEAR": {"type": ["null", "number"]},
                "MONTH": {"type": ["null", "number"]},
                "ENERGY_BAND": {"type": ["null", "string"]},
            },
        }
